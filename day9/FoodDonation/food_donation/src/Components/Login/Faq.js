...
const FAQ = () => {
  ...
  const faqItems = [
    ...
    { question: 'Can we get Tax receipt / Tax Deduction ?', answer: 'Yes, All our partner NGOs are 80G certified and you can get your Tax-recipt by mailing at contact@charitism.com.' },
